...
import { TourismHospitalityNavigationTabs } from "@/components/tourism-hospitality-navigation-tabs"
import useEmblaCarousel from "embla-carousel-react"
import { ChevronLeft, ChevronRight } from "lucide-react"
import tourismHospitality from "@/assests/Subjects/tourism-hospitality.jpg"
...
const TourismHospitalityImageCarousel = () => {
          ...
          {carouselImages.map((image, index) => (
            ...
            >
              <div className="relative w-full h-[300px] md:h-[400px] lg:h-[450px]">
                <Image
                  src={image}
                  alt={`Tourism & Hospitality image ${index + 1}`}
                  fill
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="relative w-full h-[57vh] overflow-hidden">
        <Image
          src={tourismHospitality}
          alt="Tourism & Hospitality - Study Abroad"
          fill
        ...
        <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
          <div className="text-center text-white px-4">
            ...
            <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold mb-3">
              Study Abroad in Tourism & Hospitality
            </h1>
            <p className="text-base md:text-lg font-medium">
              Serve. Welcome. Transform.
            </p>
          </div>
        </div>
      </div>
      ...
      {/* Navigation Tabs */}
      <TourismHospitalityNavigationTabs />
      ...
      <div className="max-w-6xl mx-auto py-6 md:py-8">
        ...
        <div className="mb-4 text-sm text-muted-foreground">
          ...
          <span>Study Abroad in Tourism & Hospitality</span>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
            ...
            <div>
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-3">
                What to expect when you Study Abroad in Tourism & Hospitality
              </h2>
              <div className="space-y-3 text-foreground">
                <p>
                  Studying abroad in Tourism & Hospitality offers a unique opportunity to immerse yourself 
                  in diverse hospitality environments, learn from world-renowned industry professionals and experts, 
                  and develop your service skills in inspiring international settings. Expect to explore 
                  different hospitality approaches, tourism management strategies, and cultural perspectives that will 
                  enrich your professional journey.
                </p>
                <p>
                  You'll experience life in vibrant tourism destinations, from luxury resorts in Europe 
                  to emerging hospitality centers in Asia. Tourism & Hospitality programs abroad are globally 
                  recognized for their excellence in hotel management, event planning, culinary arts, 
                  and tourism development.
                </p>
                <p>
                  The opportunity to work with international hospitality teams, learn from diverse 
                  service perspectives, and create memorable experiences inspired by new environments will enhance 
                  your professional development. Be prepared for an adventure that combines hospitality 
            ...
            <div className="relative">
              <TourismHospitalityImageCarousel />
            </div>
          </div>
        </section>
        ...
        <section id="programs" className="mb-4 md:mb-8 scroll-mt-28">
          <div className="text-left space-y-6 mb-8">
            <h2 className="text-3xl md:text-4xl font-bold text-[#424242]">
              Our Tourism & Hospitality Study Abroad Programs
            </h2>
            <p className="text-lg text-[#424242] leading-relaxed">
              Tourism & Hospitality Study Abroad Programs enhance your service skills, expand global perspectives, and provide hands-on experience that elevate both your hospitality expertise and career potential.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Study abroad at LCI Barcelona—one of Spain's premier hospitality institutions. Experience world-class academics in tourism and hospitality, immerse in Spanish culture, and earn credits abroad at an affordable cost.",
              ...
              },
              {
                ...
                description: "Discover hospitality excellence in Morocco with Al Akhawayn University. Experience hands-on training in tourism management and immerse yourself in the rich Moroccan culture.",
              ...
              },
              {
                ...
                duration: "Fall Semester, Spring Semester",
                description: "Study abroad in Hungary and master the art of hospitality at University of Pécs. Enroll today!",
              ...
              },
              {
                ...
                duration: "Fall Semester, Spring Semester, Summer Break",
                description: "Explore your passion for tourism and hospitality while studying abroad in China at Fudan University. Experience a vibrant culture, expert faculty, and unique industry opportunities.",
              ...
              },
              {
                ...
                duration: "Academic Year, Fall Semester, Spring Semester",
                description: "Discover exciting study abroad opportunities at Peking University. Immerse yourself in a vibrant culture while advancing your education in tourism and hospitality management.",
        ...
        <section className="mb-4 md:mb-8 scroll-mt-28">
          <div className="text-left space-y-6 mb-8">
            <h2 className="text-3xl md:text-4xl font-bold text-[#424242]">
              Benefits of Studying Tourism & Hospitality Abroad
            </h2>
            <p className="text-lg text-[#424242] leading-relaxed">
              Tourism & Hospitality Study Abroad Programs offer global industry perspectives, unique practical opportunities, and invaluable professional and personal growth.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3">
            ...
            <div className="border-b md:border-b-0 md:border-r border-border p-6">
              ...
              <p className="text-base text-[#424242] leading-relaxed">
                Immerse yourself in diverse hospitality traditions and tourism practices, expanding your understanding of global service standards and customer experiences.
              </p>
            </div>
            ...
            <div className="border-b md:border-b-0 md:border-r border-border p-6">
              ...
              <p className="text-base text-[#424242] leading-relaxed">
                Gain real-world experience working in international hotels, restaurants, and tourism organizations, developing unique skills that set you apart from the competition.
              </p>
            </div>
            ...
            <div className="p-6">
              ...
              <p className="text-base text-[#424242] leading-relaxed">
                Build independence, customer service skills, and a global network while living and working in an international hospitality environment.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="faqs" className="mb-8 scroll-mt-28">
          <h2 className="text-lg md:text-2xl font-bold text-foreground mb-1 md:mb-3 p-1 text-center">
            Study Abroad in Tourism & Hospitality FAQs
          </h2>
          <p className="text-muted-foreground mb-3 md:mb-4 text-sm md:text-base p-1 text-center">
            Got questions about studying abroad in Tourism & Hospitality? Get all the answers you need to 
          ...
          <Accordion type="single" collapsible className="w-full space-y-2 md:space-y-3">
            <AccordionItem value="item-1" className="border-none">
              <div className="bg-card border border-border rounded px-4 md:px-5">
                <AccordionTrigger className="text-sm md:text-base font-semibold text-foreground hover:no-underline py-3">
                  What are the benefits of studying abroad in Tourism & Hospitality?
                </AccordionTrigger>
                <AccordionContent className="text-foreground/80 pb-3">
                  Studying Tourism & Hospitality abroad offers access to world-class industry programs, diverse 
                  service approaches, and inspiring environments. You'll learn from renowned hospitality professionals 
                  and experts, explore different tourism management strategies, and develop a global 
            ...
            <AccordionItem value="item-2" className="border-none">
              <div className="bg-card border border-border rounded px-4 md:px-5">
                <AccordionTrigger className="text-sm md:text-base font-semibold text-foreground hover:no-underline py-3">
                  Do I need prior hospitality experience to study Tourism & Hospitality abroad?
                </AccordionTrigger>
                <AccordionContent className="text-foreground/80 pb-3">
                  Most Tourism & Hospitality programs welcome students at various levels. Requirements vary by 
                  program, but many accept students from different academic backgrounds. Some programs 
                  may prefer basic hospitality courses or related experience, but opportunities are 
            ...
            <AccordionItem value="item-3" className="border-none">
              <div className="bg-card border border-border rounded px-4 md:px-5">
                <AccordionTrigger className="text-sm md:text-base font-semibold text-foreground hover:no-underline py-3">
                  What types of Tourism & Hospitality programs are available?
                </AccordionTrigger>
                <AccordionContent className="text-foreground/80 pb-3">
                  Programs range from hotel management and event planning to culinary arts, tourism development, 
                  and hospitality administration. You can choose from semester programs, full degree programs, 
                  or specialized workshops. Many programs offer internships, practical training, 
                  and opportunities to work with diverse international clientele.
                </AccordionContent>
              </div>
            </AccordionItem>
            ...
            <AccordionItem value="item-4" className="border-none">
              <div className="bg-card border border-border rounded px-4 md:px-5">
                <AccordionTrigger className="text-sm md:text-base font-semibold text-foreground hover:no-underline py-3">
                  What should I know about studying Tourism & Hospitality abroad?
                </AccordionTrigger>
                <AccordionContent className="text-foreground/80 pb-3">
                  Tourism & Hospitality programs abroad offer unique opportunities to experience different 
                  service cultures, learn new hospitality techniques, and gain international exposure. Be 
                  prepared for practical training, customer service work, and cultural immersion. Many 
                  programs provide access to industry facilities and professional networks.
                </AccordionContent>
              </div>
            </AccordionItem>
          </Accordion>
