...
import { NaturalAppliedSciencesNavigationTabs } from "@/components/natural-applied-sciences-navigation-tabs"
import useEmblaCarousel from "embla-carousel-react"
import { ChevronLeft, ChevronRight } from "lucide-react"
import naturalAppliedSciences from "@/assests/Subjects/natural-applied-sciences.jpg"
...
const NaturalAppliedSciencesImageCarousel = () => {
          ...
          {carouselImages.map((image, index) => (
            ...
            >
              <div className="relative w-full h-[300px] md:h-[400px] lg:h-[450px]">
                <Image
                  src={image}
                  alt={`Natural & Applied Sciences image ${index + 1}`}
                  fill
...
export default function NaturalAppliedSciencesPage() {
  return (
    <div className="min-h-screen">
      {/* Hero Image Header */}
      <div className="relative w-full h-[57vh] overflow-hidden">
        <Image
          src={naturalAppliedSciences}
          alt="Natural & Applied Sciences - Study Abroad"
          fill
        ...
        <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
          <div className="text-center text-white px-4">
            ...
            <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold mb-3">
              Study Abroad in Natural & Applied Sciences
            </h1>
      ...
      {/* Navigation Tabs */}
      <NaturalAppliedSciencesNavigationTabs />
      ...
      <div className="max-w-6xl mx-auto py-6 md:py-8">
        ...
        <div className="mb-4 text-sm text-muted-foreground">
          ...
          <span>Study Abroad in Natural & Applied Sciences</span>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
            ...
            <div>
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-3">
                What to expect when you Study Abroad in Natural & Applied Sciences
              </h2>
              <div className="space-y-3 text-foreground">
                <p>
                  Studying abroad in Natural & Applied Sciences offers a unique opportunity to immerse yourself 
                  in diverse scientific environments, learn from world-renowned scientists and researchers, 
                  and develop your research skills in inspiring international settings. Expect to explore 
                  different scientific approaches, experimental methods, and perspectives that will 
                  enrich your academic journey.
                </p>
                <p>
                  You'll experience life in vibrant research centers, from cutting-edge laboratories in Asia 
                  to historic scientific institutions in Europe. Natural & Applied Sciences programs abroad are globally 
                  recognized for their excellence in biology, chemistry, physics, environmental science, 
                  and applied research.
                </p>
                <p>
                  The opportunity to work with international research teams, learn from diverse 
                  scientific perspectives, and conduct experiments inspired by new environments will enhance 
                  your professional development. Be prepared for an adventure that combines scientific 
            ...
            <div className="relative">
              <NaturalAppliedSciencesImageCarousel />
            </div>
          </div>
        </section>
        ...
        <section id="programs" className="mb-4 md:mb-8 scroll-mt-28">
          <div className="text-left space-y-6 mb-8">
            <h2 className="text-3xl md:text-4xl font-bold text-[#424242]">
              Our Natural & Applied Sciences Study Abroad Programs
            </h2>
            <p className="text-lg text-[#424242] leading-relaxed">
              Natural & Applied Sciences Study Abroad Programs enhance your research skills, expand global perspectives, and provide hands-on experience that elevate both your scientific expertise and career potential.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Study abroad at Peking University in Beijing—one of China's most prestigious universities. Experience world-class academics in natural sciences, immerse in Chinese culture, and earn credits abroad at an affordable cost.",
              ...
              },
              {
                ...
                description: "Discover scientific excellence in China with Fudan University. Experience hands-on research in state-of-the-art laboratories and immerse yourself in the rich Chinese culture.",
                price: "Semester: $12,995"
              },
              {
                ...
                duration: "Fall Semester, Spring Semester, Summer Break",
                description: "Study abroad in Buenos Aires and master the art of scientific research at Universidad Austral. Enroll today!",
              ...
              },
              {
                ...
                duration: "Academic Year, Fall Semester, Spring Semester",
                description: "Explore your passion for natural sciences while studying abroad in Morocco at Al Akhawayn University. Experience a vibrant culture, expert faculty, and unique research opportunities.",
              ...
              },
              {
                ...
                duration: "Fall Semester, Spring Semester",
                description: "Discover exciting study abroad opportunities at the University of Pécs. Immerse yourself in a vibrant culture while advancing your education in natural and applied sciences.",
        ...
        <section className="mb-4 md:mb-8 scroll-mt-28">
          <div className="text-left space-y-6 mb-8">
            <h2 className="text-3xl md:text-4xl font-bold text-[#424242]">
              Benefits of Studying Natural & Applied Sciences Abroad
            </h2>
            <p className="text-lg text-[#424242] leading-relaxed">
              Natural & Applied Sciences Study Abroad Programs offer global scientific perspectives, unique research opportunities, and invaluable academic and professional growth.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3">
            ...
            <div className="border-b md:border-b-0 md:border-r border-border p-6">
              ...
              <p className="text-base text-[#424242] leading-relaxed">
                Immerse yourself in diverse scientific traditions and research methodologies, expanding your understanding of global scientific practices.
              </p>
            </div>
            ...
            <div className="border-b md:border-b-0 md:border-r border-border p-6">
              ...
              <p className="text-base text-[#424242] leading-relaxed">
                Gain real-world experience in international laboratories and develop unique research projects that set you apart from the competition.
              </p>
            </div>
            ...
            <div className="p-6">
              ...
              <p className="text-base text-[#424242] leading-relaxed">
                Build independence, analytical thinking skills, and a global network while living and researching in an international scientific environment.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="faqs" className="mb-8 scroll-mt-28">
          <h2 className="text-lg md:text-2xl font-bold text-foreground mb-1 md:mb-3 p-1 text-center">
            Study Abroad in Natural & Applied Sciences FAQs
          </h2>
          <p className="text-muted-foreground mb-3 md:mb-4 text-sm md:text-base p-1 text-center">
            Got questions about studying abroad in Natural & Applied Sciences? Get all the answers you need to 
          ...
          <Accordion type="single" collapsible className="w-full space-y-2 md:space-y-3">
            <AccordionItem value="item-1" className="border-none">
              <div className="bg-card border border-border rounded px-4 md:px-5">
                <AccordionTrigger className="text-sm md:text-base font-semibold text-foreground hover:no-underline py-3">
                  What are the benefits of studying abroad in Natural & Applied Sciences?
                </AccordionTrigger>
                <AccordionContent className="text-foreground/80 pb-3">
                  Studying Natural & Applied Sciences abroad offers access to world-class research programs, diverse 
                  scientific approaches, and inspiring environments. You'll learn from renowned scientists 
                  and researchers, explore different experimental methodologies, and develop a global 
            ...
            <AccordionItem value="item-2" className="border-none">
              <div className="bg-card border border-border rounded px-4 md:px-5">
                <AccordionTrigger className="text-sm md:text-base font-semibold text-foreground hover:no-underline py-3">
                  Do I need prior science coursework to study Natural & Applied Sciences abroad?
                </AccordionTrigger>
                <AccordionContent className="text-foreground/80 pb-3">
                  Most Natural & Applied Sciences programs require foundational coursework in mathematics and science, including biology, chemistry, or physics. 
                  Requirements vary by program, but many accept students who have completed basic 
                  science prerequisites. Some programs may prefer students with specific advanced 
                  science coursework, but opportunities are available for various academic levels. Our advisors can help you 
            ...
            <AccordionItem value="item-3" className="border-none">
              <div className="bg-card border border-border rounded px-4 md:px-5">
                <AccordionTrigger className="text-sm md:text-base font-semibold text-foreground hover:no-underline py-3">
                  What types of Natural & Applied Sciences programs are available?
                </AccordionTrigger>
                <AccordionContent className="text-foreground/80 pb-3">
                  Programs range from biology and chemistry to physics, environmental science, 
                  and applied research. You can choose from semester programs, full degree programs, 
                  or specialized research opportunities. Many programs offer lab access, research projects, 
                  and opportunities to work with international scientific teams.
                </AccordionContent>
              </div>
            </AccordionItem>
            ...
            <AccordionItem value="item-4" className="border-none">
              <div className="bg-card border border-border rounded px-4 md:px-5">
                <AccordionTrigger className="text-sm md:text-base font-semibold text-foreground hover:no-underline py-3">
                  What should I know about studying Natural & Applied Sciences abroad?
                </AccordionTrigger>
                <AccordionContent className="text-foreground/80 pb-3">
                  Natural & Applied Sciences programs abroad offer unique opportunities to experience different 
                  scientific approaches, learn new research techniques, and gain international exposure. Be 
                  prepared for intensive lab work, research projects, and cultural immersion. Many 
