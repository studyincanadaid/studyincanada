...
import { CommunicationsNavigationTabs } from "@/components/communications-navigation-tabs"
...
const CommunicationsImageCarousel = () => {
          ...
          {carouselImages.map((image, index) => (
            ...
            >
              <div className="relative w-full h-[300px] md:h-[400px] lg:h-[450px]">
                <Image
                  src={image}
                  alt={`Communications image ${index + 1}`}
                  fill
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="relative w-full h-[57vh] overflow-hidden">
        <Image
          src={communications}
          alt="Communications - Study Abroad"
          fill
        ...
        <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
          <div className="text-center text-white px-4">
            ...
            <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold mb-3">
              Study Abroad in Communications
            </h1>
      ...
      <div className="max-w-6xl mx-auto py-6 md:py-8">
        ...
        <div className="mb-4 text-sm text-muted-foreground">
          ...
          <span>Study Abroad in Communications</span>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
            ...
            <div>
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-3">
                What to expect when you Study Abroad in Communications
              </h2>
              <div className="space-y-3 text-foreground">
                <p>
                  Studying abroad in Communications offers a unique opportunity to immerse yourself 
                  in diverse media cultures, learn from world-renowned journalists and communication 
                  experts, and develop your communication skills in inspiring international settings. 
                  Expect to explore different media landscapes, storytelling techniques, and perspectives 
                  that will enrich your professional journey.
                </p>
                <p>
                  You'll experience life in vibrant cultural hubs, from major media centers in Europe 
                  to emerging communication hubs in Asia. Communications programs abroad are globally 
                  recognized for their excellence in journalism, public relations, digital media, 
                  broadcasting, and strategic communication.
                </p>
                <p>
                  The opportunity to work with international media organizations, learn from diverse 
                  perspectives, and create content inspired by new environments will enhance 
                  your communication development. Be prepared for an adventure that combines professional 
                  growth with unforgettable cultural experiences and personal transformation!
                </p>
              </div>
            </div>
        ...
        <section id="programs" className="mb-4 md:mb-8 scroll-mt-28">
          <div className="text-left space-y-6 mb-8">
            <h2 className="text-3xl md:text-4xl font-bold text-[#424242]">
              Our Communications Study Abroad Programs
            </h2>
            <p className="text-lg text-[#424242] leading-relaxed">
              Communications Study Abroad Programs enhance your media skills, expand global perspectives, and provide hands-on experience that elevate both your communication abilities and career potential.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Study abroad at Fudan University in Shanghai—one of China's top-ranked universities. Experience world-class academics in media and communications, immerse in Chinese culture, and earn credits abroad at an affordable cost.",
              ...
              },
              {
                ...
                description: "Discover media excellence in Spain with LCI Barcelona. Experience hands-on training in digital communications and immerse yourself in the rich Spanish culture.",
              ...
              },
              {
                ...
                duration: "Fall Semester, Spring Semester, Summer Break",
                description: "Study abroad in Buenos Aires and master the art of strategic communication at Universidad Austral. Enroll today!",
              ...
              },
              {
                ...
                duration: "Academic Year, Fall Semester, Spring Semester",
                description: "Explore your passion for journalism and communications while studying abroad in Morocco at Al Akhawayn University. Experience a vibrant culture, expert faculty, and unique media opportunities.",
              ...
              },
              {
                ...
                duration: "Fall Semester, Spring Semester",
                description: "Discover exciting study abroad opportunities at the University of Pécs. Immerse yourself in a vibrant culture while advancing your education in media and communications.",
        ...
        <section className="mb-4 md:mb-8 scroll-mt-28">
          <div className="text-left space-y-6 mb-8">
            <h2 className="text-3xl md:text-4xl font-bold text-[#424242]">
              Benefits of Studying Communications Abroad
            </h2>
            <p className="text-lg text-[#424242] leading-relaxed">
              Communications Study Abroad Programs offer global media perspectives, unique portfolio enhancement, and invaluable cultural and professional growth opportunities.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3">
            ...
            <div className="border-b md:border-b-0 md:border-r border-border p-6">
              ...
              <p className="text-base text-[#424242] leading-relaxed">
                Immerse yourself in diverse media cultures and communication traditions, expanding your understanding of global communication strategies.
              </p>
            </div>
            ...
            <div className="p-6">
              ...
              <p className="text-base text-[#424242] leading-relaxed">
                Build independence, adaptability, and a global network while living and working in an international environment.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="faqs" className="mb-8 scroll-mt-28">
          <h2 className="text-lg md:text-2xl font-bold text-foreground mb-1 md:mb-3 p-1 text-center">
            Study Abroad in Communications FAQs
          </h2>
          <p className="text-muted-foreground mb-3 md:mb-4 text-sm md:text-base p-1 text-center">
            Got questions about studying abroad in Communications? Get all the answers you need to 
          ...
          <Accordion type="single" collapsible className="w-full space-y-2 md:space-y-3">
            <AccordionItem value="item-1" className="border-none">
              <div className="bg-card border border-border rounded px-4 md:px-5">
                <AccordionTrigger className="text-sm md:text-base font-semibold text-foreground hover:no-underline py-3">
                  What are the benefits of studying abroad in Communications?
                </AccordionTrigger>
                <AccordionContent className="text-foreground/80 pb-3">
                  Studying Communications abroad offers access to world-class media programs, diverse 
                  communication cultures, and inspiring environments. You'll learn from renowned journalists 
                  and communication experts, explore different media landscapes, and develop a global 
            ...
            <AccordionItem value="item-2" className="border-none">
              <div className="bg-card border border-border rounded px-4 md:px-5">
                <AccordionTrigger className="text-sm md:text-base font-semibold text-foreground hover:no-underline py-3">
                  Do I need prior experience to study Communications abroad?
                </AccordionTrigger>
                <AccordionContent className="text-foreground/80 pb-3">
                  Most Communications programs welcome students at various levels. Requirements vary by 
                  program, but many accept students from different academic backgrounds. Some programs 
                  may prefer basic communication courses or related experience, but opportunities are 
            ...
            <AccordionItem value="item-3" className="border-none">
              <div className="bg-card border border-border rounded px-4 md:px-5">
                <AccordionTrigger className="text-sm md:text-base font-semibold text-foreground hover:no-underline py-3">
                  What types of Communications programs are available?
                </AccordionTrigger>
                <AccordionContent className="text-foreground/80 pb-3">
                  Programs range from journalism and broadcasting to public relations, digital media, 
                  and strategic communication. You can choose from semester programs, full degree programs, 
                  or specialized workshops. Many programs offer internships, media visits, and 
            ...
            <AccordionItem value="item-4" className="border-none">
              <div className="bg-card border border-border rounded px-4 md:px-5">
                <AccordionTrigger className="text-sm md:text-base font-semibold text-foreground hover:no-underline py-3">
                  What should I know about studying Communications abroad?
                </AccordionTrigger>
                <AccordionContent className="text-foreground/80 pb-3">
                  Communications programs abroad offer unique opportunities to experience different 
                  media cultures, learn new communication techniques, and gain international exposure. Be 
                  prepared for hands-on projects, portfolio development, and cultural immersion. Many 
                  programs provide access to media facilities and professional networks.
                </AccordionContent>
              </div>
            </AccordionItem>
          </Accordion>
