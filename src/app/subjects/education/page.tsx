...
import { EducationNavigationTabs } from "@/components/education-navigation-tabs"
    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-6xl mx-auto py-6 md:py-8">
        ...
        <div className="mb-4 text-sm text-muted-foreground">
          ...
          <span>Study Abroad in Education</span>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
            ...
            <div>
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-3">
                What to expect when you Study Abroad in Education
              </h2>
              <div className="space-y-3 text-foreground">
                <p>
                  Studying abroad in Education offers a unique opportunity to immerse yourself 
                  in diverse educational systems, learn from world-renowned educators and researchers, 
                  and develop your teaching skills in inspiring international settings. Expect to explore 
                  different pedagogical approaches, learning methodologies, and perspectives that will 
                  enrich your educational journey.
                </p>
                <p>
                  You'll experience life in vibrant cultural hubs, from historic educational centers in Europe 
                  to innovative teaching institutions in Asia. Education programs abroad are globally 
                  recognized for their excellence in teacher training, educational research, curriculum 
                  development, and educational policy.
                </p>
                <p>
                  The opportunity to observe international classrooms, collaborate with global educators, 
                  and create educational content inspired by new environments will enhance 
                  your professional development. Be prepared for an adventure that combines educational 
        ...
        <section id="programs" className="mb-4 md:mb-8 scroll-mt-28">
          <div className="text-left space-y-6 mb-8">
            <h2 className="text-3xl md:text-4xl font-bold text-[#424242]">
              Our Education Study Abroad Programs
            </h2>
            <p className="text-lg text-[#424242] leading-relaxed">
              Education Study Abroad Programs enhance your teaching skills, expand global perspectives, and provide hands-on experience that elevate both your educational expertise and career potential.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Study abroad at Tsinghua University in Beijing—one of China's most prestigious universities. Experience world-class academics in education, immerse in Chinese culture, and earn credits abroad at an affordable cost.",
              ...
              },
              {
                ...
                description: "Discover educational excellence in China with Fudan University. Experience hands-on training in teaching methodologies and immerse yourself in the rich Chinese culture.",
                price: "Semester: $12,995"
              },
              {
                ...
                duration: "Fall Semester, Spring Semester, Summer Break",
                description: "Study abroad in Buenos Aires and master the art of educational leadership at Universidad Austral. Enroll today!",
              ...
              },
              {
                ...
                duration: "Academic Year, Fall Semester, Spring Semester",
                description: "Explore your passion for education while studying abroad in Morocco at Al Akhawayn University. Experience a vibrant culture, expert faculty, and unique teaching opportunities.",
              ...
              },
              {
                ...
                duration: "Fall Semester, Spring Semester",
                description: "Discover exciting study abroad opportunities at the University of Pécs. Immerse yourself in a vibrant culture while advancing your education in pedagogy and educational research.",
        ...
        <section className="mb-4 md:mb-8 scroll-mt-28">
          <div className="text-left space-y-6 mb-8">
            <h2 className="text-3xl md:text-4xl font-bold text-[#424242]">
              Benefits of Studying Education Abroad
            </h2>
            <p className="text-lg text-[#424242] leading-relaxed">
              Education Study Abroad Programs offer global teaching perspectives, unique professional development, and invaluable cultural and personal growth opportunities.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3">
            ...
            <div className="border-b md:border-b-0 md:border-r border-border p-6">
              ...
              <p className="text-base text-[#424242] leading-relaxed">
                Immerse yourself in diverse educational systems and teaching methodologies, expanding your understanding of global educational practices.
              </p>
            </div>
            ...
            <div className="border-b md:border-b-0 md:border-r border-border p-6">
              ...
              <p className="text-base text-[#424242] leading-relaxed">
                Gain real-world experience in international classrooms and develop unique teaching strategies that set you apart from the competition.
              </p>
            </div>
            ...
            <div className="p-6">
              ...
              <p className="text-base text-[#424242] leading-relaxed">
                Build independence, adaptability, and a global network while living and teaching in an international environment.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="faqs" className="mb-8 scroll-mt-28">
          <h2 className="text-lg md:text-2xl font-bold text-foreground mb-1 md:mb-3 p-1 text-center">
            Study Abroad in Education FAQs
          </h2>
          <p className="text-muted-foreground mb-3 md:mb-4 text-sm md:text-base p-1 text-center">
            Got questions about studying abroad in Education? Get all the answers you need to 
          ...
          <Accordion type="single" collapsible className="w-full space-y-2 md:space-y-3">
            <AccordionItem value="item-1" className="border-none">
              <div className="bg-card border border-border rounded px-4 md:px-5">
                <AccordionTrigger className="text-sm md:text-base font-semibold text-foreground hover:no-underline py-3">
                  What are the benefits of studying abroad in Education?
                </AccordionTrigger>
                <AccordionContent className="text-foreground/80 pb-3">
                  Studying Education abroad offers access to world-class educational programs, diverse 
                  teaching methodologies, and inspiring environments. You'll learn from renowned educators 
                  and researchers, explore different educational systems, and develop a global 
            ...
            <AccordionItem value="item-2" className="border-none">
              <div className="bg-card border border-border rounded px-4 md:px-5">
                <AccordionTrigger className="text-sm md:text-base font-semibold text-foreground hover:no-underline py-3">
                  Do I need teaching experience to study Education abroad?
                </AccordionTrigger>
                <AccordionContent className="text-foreground/80 pb-3">
                  Most Education programs welcome students at various levels. Requirements vary by 
                  program, but many accept students from different academic backgrounds. Some programs 
                  may prefer basic education courses or related experience, but opportunities are 
            ...
            <AccordionItem value="item-3" className="border-none">
              <div className="bg-card border border-border rounded px-4 md:px-5">
                ...
                <AccordionContent className="text-foreground/80 pb-3">
                  Programs range from teacher training and curriculum development to educational research, 
                  special education, and educational leadership. You can choose from semester programs, 
                  full degree programs, or specialized workshops. Many programs offer classroom observations, 
                  teaching practicums, and opportunities to work with diverse student populations.
                </AccordionContent>
              </div>
            </AccordionItem>
            ...
            <AccordionItem value="item-4" className="border-none">
              <div className="bg-card border border-border rounded px-4 md:px-5">
                <AccordionTrigger className="text-sm md:text-base font-semibold text-foreground hover:no-underline py-3">
                  What should I know about studying Education abroad?
                </AccordionTrigger>
                <AccordionContent className="text-foreground/80 pb-3">
                  Education programs abroad offer unique opportunities to experience different 
                  educational systems, learn new teaching techniques, and gain international exposure. Be 
                  prepared for classroom observations, teaching practicums, and cultural immersion. Many 
                  programs provide access to educational facilities and professional networks.
                </AccordionContent>
              </div>
            </AccordionItem>
          </Accordion>
