...
import { MathNavigationTabs } from "@/components/math-navigation-tabs"
import useEmblaCarousel from "embla-carousel-react"
import { ChevronLeft, ChevronRight } from "lucide-react"
import math from "@/assests/Subjects/math.jpg"
    ...
    <div className="min-h-screen">
        ...
        <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
          <div className="text-center text-white px-4">
            ...
            <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold mb-3">
              Study Abroad in Math
            </h1>
            <p className="text-base md:text-lg font-medium">
              Calculate. Solve. Transform.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto py-6 md:py-8">
        ...
        <div className="mb-4 text-sm text-muted-foreground">
          ...
          <span>Study Abroad in Math</span>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
            ...
            <div>
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-3">
                What to expect when you Study Abroad in Math
              </h2>
              <div className="space-y-3 text-foreground">
                <p>
                  Studying abroad in Math offers a unique opportunity to immerse yourself 
                  in diverse mathematical traditions, learn from world-renowned mathematicians and researchers, 
                  and develop your problem-solving skills in inspiring international settings. Expect to explore 
                  different mathematical approaches, theoretical frameworks, and perspectives that will 
                  enrich your academic journey.
                </p>
                <p>
                  You'll experience life in vibrant academic centers, from prestigious universities in Asia 
                  to historic mathematical institutions in Europe. Math programs abroad are globally 
                  recognized for their excellence in pure mathematics, applied mathematics, statistics, 
                  and mathematical modeling.
                </p>
                <p>
                  The opportunity to work with international research teams, learn from diverse 
                  mathematical perspectives, and solve problems inspired by new environments will enhance 
                  your intellectual development. Be prepared for an adventure that combines mathematical 
        ...
        <section id="programs" className="mb-4 md:mb-8 scroll-mt-28">
          <div className="text-left space-y-6 mb-8">
            <h2 className="text-3xl md:text-4xl font-bold text-[#424242]">
              Our Math Study Abroad Programs
            </h2>
            <p className="text-lg text-[#424242] leading-relaxed">
              Math Study Abroad Programs enhance your analytical skills, expand global perspectives, and provide hands-on experience that elevate both your mathematical expertise and career potential.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Study abroad at Tsinghua University in Beijing—one of China's most prestigious universities. Experience world-class academics in mathematics, immerse in Chinese culture, and earn credits abroad at an affordable cost.",
              ...
              },
              {
                ...
                description: "Discover mathematical excellence in China with Fudan University. Experience hands-on learning in advanced mathematics and immerse yourself in the rich Chinese culture.",
                price: "Semester: $12,995"
              },
              {
                ...
                duration: "Fall Semester, Spring Semester, Summer Break",
                description: "Study abroad in Buenos Aires and master the art of mathematics at Universidad Austral. Enroll today!",
              ...
              },
              {
                ...
                duration: "Academic Year, Fall Semester, Spring Semester",
                description: "Explore your passion for mathematics while studying abroad in Morocco at Al Akhawayn University. Experience a vibrant culture, expert faculty, and unique research opportunities.",
              ...
              },
              {
                ...
                duration: "Fall Semester, Spring Semester",
                description: "Discover exciting study abroad opportunities at the University of Pécs. Immerse yourself in a vibrant culture while advancing your education in mathematics and statistics.",
        ...
        <section className="mb-4 md:mb-8 scroll-mt-28">
          <div className="text-left space-y-6 mb-8">
            <h2 className="text-3xl md:text-4xl font-bold text-[#424242]">
              Benefits of Studying Math Abroad
            </h2>
            <p className="text-lg text-[#424242] leading-relaxed">
              Math Study Abroad Programs offer global mathematical perspectives, unique research opportunities, and invaluable academic and professional growth.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3">
            {/* Global Mathematical Perspectives */}
            <div className="border-b md:border-b-0 md:border-r border-border p-6">
              ...
              <p className="text-base text-[#424242] leading-relaxed">
                Immerse yourself in diverse mathematical traditions and problem-solving approaches, expanding your understanding of global mathematical practices.
              </p>
            </div>
            ...
            <div className="border-b md:border-b-0 md:border-r border-border p-6">
              ...
              <p className="text-base text-[#424242] leading-relaxed">
                Gain real-world experience in international research labs and develop unique mathematical projects that set you apart from the competition.
              </p>
            </div>
            ...
            <div className="p-6">
              ...
              <p className="text-base text-[#424242] leading-relaxed">
                Build independence, analytical thinking skills, and a global network while living and studying in an international academic environment.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="faqs" className="mb-8 scroll-mt-28">
          <h2 className="text-lg md:text-2xl font-bold text-foreground mb-1 md:mb-3 p-1 text-center">
            Study Abroad in Math FAQs
          </h2>
          <p className="text-muted-foreground mb-3 md:mb-4 text-sm md:text-base p-1 text-center">
            Got questions about studying abroad in Math? Get all the answers you need to 
          ...
          <Accordion type="single" collapsible className="w-full space-y-2 md:space-y-3">
            <AccordionItem value="item-1" className="border-none">
              <div className="bg-card border border-border rounded px-4 md:px-5">
                <AccordionTrigger className="text-sm md:text-base font-semibold text-foreground hover:no-underline py-3">
                  What are the benefits of studying abroad in Math?
                </AccordionTrigger>
                <AccordionContent className="text-foreground/80 pb-3">
                  Studying Math abroad offers access to world-class mathematical programs, diverse 
                  problem-solving approaches, and inspiring environments. You'll learn from renowned mathematicians 
                  and researchers, explore different mathematical traditions, and develop a global 
            ...
            <AccordionItem value="item-2" className="border-none">
              <div className="bg-card border border-border rounded px-4 md:px-5">
                <AccordionTrigger className="text-sm md:text-base font-semibold text-foreground hover:no-underline py-3">
                  Do I need prior mathematics coursework to study Math abroad?
                </AccordionTrigger>
                <AccordionContent className="text-foreground/80 pb-3">
                  Most Math programs require foundational coursework in mathematics, including calculus and algebra. 
                  Requirements vary by program, but many accept students who have completed basic 
                  mathematics prerequisites. Some programs may prefer students with specific advanced 
                  mathematics coursework, but opportunities are available for various academic levels. Our advisors can help you 
            ...
            <AccordionItem value="item-3" className="border-none">
              <div className="bg-card border border-border rounded px-4 md:px-5">
                <AccordionTrigger className="text-sm md:text-base font-semibold text-foreground hover:no-underline py-3">
                  What types of Math programs are available?
                </AccordionTrigger>
                <AccordionContent className="text-foreground/80 pb-3">
                  Programs range from pure mathematics and applied mathematics to statistics, mathematical modeling, 
                  and computational mathematics. You can choose from semester programs, full degree programs, 
                  or specialized research opportunities. Many programs offer lab access, research projects, 
                  and opportunities to work with international mathematical teams.
                </AccordionContent>
              </div>
            </AccordionItem>
            ...
            <AccordionItem value="item-4" className="border-none">
              <div className="bg-card border border-border rounded px-4 md:px-5">
                <AccordionTrigger className="text-sm md:text-base font-semibold text-foreground hover:no-underline py-3">
                  What should I know about studying Math abroad?
                </AccordionTrigger>
                <AccordionContent className="text-foreground/80 pb-3">
                  Math programs abroad offer unique opportunities to experience different 
                  mathematical approaches, learn new problem-solving techniques, and gain international exposure. Be 
                  prepared for intensive coursework, research projects, and cultural immersion. Many 
