...
import { WorldLanguagesNavigationTabs } from "@/components/world-languages-navigation-tabs"
import useEmblaCarousel from "embla-carousel-react"
import { ChevronLeft, ChevronRight } from "lucide-react"
import worldLanguages from "@/assests/Subjects/world-languages.jpg"
...
const WorldLanguagesImageCarousel = () => {
          ...
          {carouselImages.map((image, index) => (
            ...
            >
              <div className="relative w-full h-[300px] md:h-[400px] lg:h-[450px]">
                <Image
                  src={image}
                  alt={`World Languages image ${index + 1}`}
                  fill
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="relative w-full h-[57vh] overflow-hidden">
        <Image
          src={worldLanguages}
          alt="World Languages - Study Abroad"
          fill
        ...
        <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
          <div className="text-center text-white px-4">
            ...
            <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold mb-3">
              Study Abroad in World Languages
            </h1>
      ...
      <div className="max-w-6xl mx-auto py-6 md:py-8">
        ...
        <div className="mb-4 text-sm text-muted-foreground">
          ...
          <span>Study Abroad in World Languages</span>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
            ...
            <div>
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-3">
                What to expect when you Study Abroad in World Languages
              </h2>
              <div className="space-y-3 text-foreground">
                <p>
                  Studying abroad in World Languages offers a unique opportunity to immerse yourself 
                  in diverse linguistic environments, learn from native speakers and expert instructors, 
                  and develop your language skills in authentic cultural settings. Expect to explore 
                  different communication styles, cultural nuances, and linguistic perspectives that will 
                  enrich your language learning journey.
                </p>
                <p>
                  You'll experience life in vibrant language communities, from historic language centers in Europe 
                  to emerging linguistic hubs in Asia. World Languages programs abroad are globally 
                  recognized for their excellence in language instruction, cultural immersion, 
                  and communicative competence.
                </p>
                <p>
                  The opportunity to practice with native speakers, engage in cultural activities, 
                  and live in a language-rich environment will enhance 
                  your linguistic development. Be prepared for an adventure that combines language 
        ...
        <section id="programs" className="mb-4 md:mb-8 scroll-mt-28">
          <div className="text-left space-y-6 mb-8">
            <h2 className="text-3xl md:text-4xl font-bold text-[#424242]">
              Our World Languages Study Abroad Programs
            </h2>
            <p className="text-lg text-[#424242] leading-relaxed">
              World Languages Study Abroad Programs enhance your language skills, expand global perspectives, and provide immersive experiences that elevate both your linguistic proficiency and career potential.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Study abroad at Peking University in Beijing—one of China's most prestigious universities. Experience world-class academics in Chinese language, immerse in Chinese culture, and earn credits abroad at an affordable cost.",
              ...
              },
              {
                ...
                description: "Discover language excellence in China with Fudan University. Experience hands-on learning in Mandarin Chinese and immerse yourself in the rich Chinese culture.",
                price: "Semester: $12,995"
              },
              {
                image: lciBarcelona,
                ...
                duration: "Fall Semester, Spring Semester",
                description: "Study abroad in Barcelona and master Spanish at LCI Barcelona. Experience authentic language immersion and enroll today!",
              ...
              },
              {
                ...
                duration: "Academic Year, Fall Semester, Spring Semester",
                description: "Explore your passion for Arabic and French while studying abroad in Morocco at Al Akhawayn University. Experience a vibrant culture, expert faculty, and unique language opportunities.",
              ...
              },
              {
                ...
                duration: "Fall Semester, Spring Semester",
                description: "Discover exciting study abroad opportunities at the University of Pécs. Immerse yourself in a vibrant culture while advancing your education in Hungarian and European languages.",
        ...
        <section className="mb-4 md:mb-8 scroll-mt-28">
          <div className="text-left space-y-6 mb-8">
            <h2 className="text-3xl md:text-4xl font-bold text-[#424242]">
              Benefits of Studying World Languages Abroad
            </h2>
            <p className="text-lg text-[#424242] leading-relaxed">
              World Languages Study Abroad Programs offer authentic language immersion, unique cultural opportunities, and invaluable linguistic and personal growth.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3">
            ...
            <div className="border-b md:border-b-0 md:border-r border-border p-6">
              ...
              <p className="text-base text-[#424242] leading-relaxed">
                Immerse yourself in native-speaking environments and daily language use, expanding your understanding of linguistic nuances and cultural communication.
              </p>
            </div>
            ...
            <div className="border-b md:border-b-0 md:border-r border-border p-6">
              ...
              <p className="text-base text-[#424242] leading-relaxed">
                Gain real-world experience using the language in authentic contexts and developing fluency that sets you apart from the competition.
              </p>
            </div>
            ...
            <div className="p-6">
              ...
              <p className="text-base text-[#424242] leading-relaxed">
                Build independence, communication skills, and a global network while living and learning in an international language environment.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="faqs" className="mb-8 scroll-mt-28">
          <h2 className="text-lg md:text-2xl font-bold text-foreground mb-1 md:mb-3 p-1 text-center">
            Study Abroad in World Languages FAQs
          </h2>
          <p className="text-muted-foreground mb-3 md:mb-4 text-sm md:text-base p-1 text-center">
            Got questions about studying abroad in World Languages? Get all the answers you need to 
            kickstart your language learning journey with confidence!
          </p>
          ...
          <Accordion type="single" collapsible className="w-full space-y-2 md:space-y-3">
            <AccordionItem value="item-1" className="border-none">
              <div className="bg-card border border-border rounded px-4 md:px-5">
                <AccordionTrigger className="text-sm md:text-base font-semibold text-foreground hover:no-underline py-3">
                  What are the benefits of studying abroad in World Languages?
                </AccordionTrigger>
                <AccordionContent className="text-foreground/80 pb-3">
                  Studying World Languages abroad offers access to authentic language immersion, diverse 
                  cultural experiences, and inspiring environments. You'll learn from native speakers 
                  and expert instructors, explore different communication styles, and develop fluency 
                  that enhances your academic portfolio and career prospects.
                </AccordionContent>
              </div>
            </AccordionItem>
            ...
            <AccordionItem value="item-2" className="border-none">
              <div className="bg-card border border-border rounded px-4 md:px-5">
                <AccordionTrigger className="text-sm md:text-base font-semibold text-foreground hover:no-underline py-3">
                  Do I need prior language experience to study World Languages abroad?
                </AccordionTrigger>
                <AccordionContent className="text-foreground/80 pb-3">
                  Most World Languages programs welcome students at various levels, from complete beginners 
                  to advanced learners. Requirements vary by program, but many accept students from different 
                  language backgrounds. Some programs may prefer basic language courses, but opportunities are 
                  available for all levels. Our advisors can help you 
            ...
            <AccordionItem value="item-3" className="border-none">
              <div className="bg-card border border-border rounded px-4 md:px-5">
                <AccordionTrigger className="text-sm md:text-base font-semibold text-foreground hover:no-underline py-3">
                  What types of World Languages programs are available?
                </AccordionTrigger>
                <AccordionContent className="text-foreground/80 pb-3">
                  Programs range from intensive language courses to cultural immersion programs, 
                  and academic language study. You can choose from semester programs, full degree programs, 
                  or specialized workshops. Many programs offer conversation practice, cultural activities, 
                  and opportunities to live with host families or in language-focused housing.
                </AccordionContent>
              </div>
            </AccordionItem>
            ...
            <AccordionItem value="item-4" className="border-none">
              <div className="bg-card border border-border rounded px-4 md:px-5">
                <AccordionTrigger className="text-sm md:text-base font-semibold text-foreground hover:no-underline py-3">
                  What should I know about studying World Languages abroad?
                </AccordionTrigger>
                <AccordionContent className="text-foreground/80 pb-3">
                  World Languages programs abroad offer unique opportunities to experience authentic 
                  language use, learn from native speakers, and gain international exposure. Be 
                  prepared for intensive language practice, cultural immersion, and daily communication. Many 
                  programs provide language exchange opportunities and professional networks.
                </AccordionContent>
              </div>
            </AccordionItem>
          </Accordion>
