      ...
      <div className="max-w-6xl mx-auto px-4 py-8 md:py-12">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-[#424242] mb-6 flex items-center gap-3">
            <ClipboardList className="h-8 w-8 text-[#C8102E]" />
            Application Checklist
          </h2>
              ...
              <CardContent>
                <ul className="space-y-3 text-muted-foreground">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-[#C8102E] mt-0.5 flex-shrink-0" />
        ...
        <section className="mb-12">
          ...
          <div className="relative">
            ...
            <div className="hidden md:block absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-[#C8102E] via-[#C8102E]/50 to-[#C8102E]"></div>
            
            <div className="space-y-8 md:space-y-12">
              {/* Step 1 */}
              <div className="relative flex gap-6 md:gap-8">
                <div className="flex-shrink-0 relative z-10">
                  <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-gradient-to-br from-[#C8102E] to-[#16a075] text-white flex items-center justify-center font-bold text-xl md:text-2xl shadow-lg border-4 border-white">
                    <Search className="h-6 w-6 md:h-8 md:w-8" />
                  </div>
                </div>
                <Card className="flex-1 border-2 border-border hover:border-[#C8102E]/50 hover:shadow-xl transition-all duration-300 group">
                  <CardContent className="p-6 md:p-8">
                    <div className="flex items-center gap-3 mb-4">
                      <span className="text-sm font-bold text-[#C8102E] bg-[#C8102E]/10 px-3 py-1 rounded-full">STEP 1</span>
                      <h3 className="text-xl md:text-2xl font-bold text-[#424242] group-hover:text-[#C8102E] transition-colors">
              ...
              <div className="relative flex gap-6 md:gap-8">
                ...
                <Card className="flex-1 border-2 border-border hover:border-[#C8102E]/50 hover:shadow-xl transition-all duration-300 group">
                  <CardContent className="p-6 md:p-8">
                    <div className="flex items-center gap-3 mb-4">
                      <span className="text-sm font-bold text-[#C8102E] bg-[#C8102E]/10 px-3 py-1 rounded-full">STEP 2</span>
                      <h3 className="text-xl md:text-2xl font-bold text-[#424242] group-hover:text-[#C8102E] transition-colors">
              ...
              <div className="relative flex gap-6 md:gap-8">
                ...
                <Card className="flex-1 border-2 border-border hover:border-[#C8102E]/50 hover:shadow-xl transition-all duration-300 group">
                  <CardContent className="p-6 md:p-8">
                    <div className="flex items-center gap-3 mb-4">
                      <span className="text-sm font-bold text-[#C8102E] bg-[#C8102E]/10 px-3 py-1 rounded-full">STEP 3</span>
                      <h3 className="text-xl md:text-2xl font-bold text-[#424242] group-hover:text-[#C8102E] transition-colors">
              ...
              <div className="relative flex gap-6 md:gap-8">
                ...
                <Card className="flex-1 border-2 border-border hover:border-[#C8102E]/50 hover:shadow-xl transition-all duration-300 group">
                  <CardContent className="p-6 md:p-8">
                    <div className="flex items-center gap-3 mb-4">
                      <span className="text-sm font-bold text-[#C8102E] bg-[#C8102E]/10 px-3 py-1 rounded-full">STEP 4</span>
                      <h3 className="text-xl md:text-2xl font-bold text-[#424242] group-hover:text-[#C8102E] transition-colors">
              ...
              <div className="relative flex gap-6 md:gap-8">
                ...
                <Card className="flex-1 border-2 border-border hover:border-[#C8102E]/50 hover:shadow-xl transition-all duration-300 group">
                  <CardContent className="p-6 md:p-8">
                    <div className="flex items-center gap-3 mb-4">
                      <span className="text-sm font-bold text-[#C8102E] bg-[#C8102E]/10 px-3 py-1 rounded-full">STEP 5</span>
                      <h3 className="text-xl md:text-2xl font-bold text-[#424242] group-hover:text-[#C8102E] transition-colors">
              ...
              <div className="relative flex gap-6 md:gap-8">
                ...
                <Card className="flex-1 border-2 border-border hover:border-[#C8102E]/50 hover:shadow-xl transition-all duration-300 group">
                  <CardContent className="p-6 md:p-8">
                    <div className="flex items-center gap-3 mb-4">
                      <span className="text-sm font-bold text-[#C8102E] bg-[#C8102E]/10 px-3 py-1 rounded-full">STEP 6</span>
                      <h3 className="text-xl md:text-2xl font-bold text-[#424242] group-hover:text-[#C8102E] transition-colors">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-[#424242] mb-6 flex items-center gap-3">
            <Calendar className="h-8 w-8 text-[#C8102E]" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <ul className="space-y-2 text-muted-foreground">
                    <li className="flex items-start gap-2">
                      <Clock className="h-4 w-4 text-[#C8102E] mt-0.5 flex-shrink-0" />
